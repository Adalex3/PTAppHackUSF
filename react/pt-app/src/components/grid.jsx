...
const Grid = () => {
    ...
    <div className='grid-wrapper'>
      ...
      <div className='grid-container'>
        <button 
          className={`button grid-button ${selectedTop === 0 ? 'selected' : ''}`} 
          onClick={() => handleTopButtonClick(0)}>
          SLOW SQUATS 
        </button>
        <button 
          className={`button grid-button ${selectedTop === 1 ? 'selected' : ''}`} 
          onClick={() => handleTopButtonClick(1)}>
            HAMSTRING STRETCH
        </button>
        <button 
          className={`button grid-button ${selectedTop === 2 ? 'selected' : ''}`} 
      ...
      {/* Bottom Row */}
        <button 
          className={`button grid-button ${selectedBottom === 0 ? 'selected' : ''}`} 
          onClick={() => handleBottomButtonClick(0)}>
          5
        </button>
        <button 
          className={`button grid-button ${selectedBottom === 1 ? 'selected' : ''}`} 
          onClick={() => handleBottomButtonClick(1)}>
          8
        </button>
        <button 
          className={`button grid-button ${selectedBottom === 2 ? 'selected' : ''}`} 
